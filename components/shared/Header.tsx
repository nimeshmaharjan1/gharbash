                    ...
                    {user ? (
                        <div className="dropdown dropdown-end">
                            <label tabIndex={0} className="avatar online cursor-pointer">
                                <div className="w-12 h-12 rounded-full  transition-all duration-100 hover:border-4 border-secondary">
                                    <Image layout="responsive" width={60} height={60} src={user?.image as string} alt="profile"></Image>
                                </div>
                            </label>
